...
public class Level9Activity extends AppCompatActivity implements View.OnClickListener, RewardedVideoAdListener {
    ...
    private String[][] arrQuestions = {
            ...
            {"Who was the last champion to be chosen in 1994 Triwizard Tournament?", "Harry Potter"},
            {"Harry was the last champion to pick a dragon and he was left with ...", "Hungarian Horntail"},
            {"In first task, Harry summoned broomstick using this spell ...    ", "Accio Firebolt"},
            {"The scores are in and Harry was tied for first place with which champion...?", "Viktor Krum"},
            {"Next clue is in the golden egg but when Harry opened it, it produced wailing and screeching whine. Cedric advised Harry to take bath in ...", "Prefects bathroom"},
            ...
            {"Who was the person impersonating Mad-eye Moody?", "Barty Crouch Jr."},
    ...
    private void displayInfo() {
        ...
        textInfo.setText("Test your knowledge on Triwizard Tournament!" +
                " Select appropriate options for given questions." +
    ...
    private void prepareExit() {
        ...
        txtQuestion.setText(arrQuestions[26][0]);
