...
public class Level1Activity extends AppCompatActivity implements View.OnClickListener, RewardedVideoAdListener {
    ...
    private String[][] arrQuestions = {
            {"Tons of shopping to do. Oh dear!(Looking at the list). Let’s go to Diagon alley, shall we?", "Diagon Alley"},
            {"This money won’t be sufficient (Counting money in the purse).I should withdraw few galleons first.", "Gringotts"},
            {"Fred broke the nimbus again in Quidditch match. I tell you, this is the last time I am buying him any supplies.", "Quality Quidditch Supplies"},
            {"Ginny is going to Hogwarts this year. She will be delighted to have a new wand.", "Ollivanders"},
            {"Next on the list: book by Gilderoy Lockhart, I will get him to sign his books (Mrs.Weasley’s eyes glowed).", "Flourish and Blotts"},
            {"Kids grew 3 inches this summer. Need to buy new robes; this is going to be expensive (Sigh!).", "Madam Malkins"},
            {"Ginny needs new cauldron too and set of glass or crystal phials and brass scale.", "Potages Cauldrons"},
            {"This year’s cabbage farm has been ruined by flesh-eating slugs. Where can I find some repellant? Ah! May be in some dodgy location.", "Knockturn Alley"},
            {"Shopping is exhausting (Mrs. Weasley glances over the other side of street). I can treat myself a couple of scoops of ice-cream once in awhile.", "Florean Fortescue's"},
            {"We have run out of food for Errol, poor old bird. Where would I get some food for him?", "Magical Menagerie"},
            {"Mr. Weasley likes to keep up with wizarding news. I tell you it’s an expensive habit. Have to pay 5 galleons in annual dues.", "Daily Prophet Office"},
            {"Kids will love butterbeers on the train to Hogwarts. Let’s get some, shall we?", "The Leaky Cauldron"},
            {"Finally the list is done. Wait, am I forgetting something? Oh yeah! Tickets for Hogwarts Express.", "King’s Cross Ticketing"},
            {"Shopping is hard than I presumed. I hope I haven’t missed anything (looking down the list). I appreciate all your help! :)", "Wiseacres"},
            {"", "Gambol and Japes"}
    };
    ...
    private void displayInfo() {
        ...
        textInfo.setText("Take Mrs. Weasley to adventurous shopping!" +
    ...
    private void initId() {
        ...
        imageButton.setImageResource(R.drawable.ic_molly);
    ...
    private void prepareExit() {
        ...
        txtQuestion.setText(arrQuestions[13][0]);
